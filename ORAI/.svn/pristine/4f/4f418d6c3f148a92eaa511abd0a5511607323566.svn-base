                  ...
                  <div class="row full-height align-items-center">
                    <div class="col-md-6">
                      <ul class="list-unstyled menu">
                        ...
                        <li><a href="/ORAI/villa/ko_message.jsp">KO.ver</a></li>
                        <li class="active"><a href="/ORAI/villa/index.jsp">ENG.ver</a></li>
                      </ul>
                    </div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    function goLogin(){
		...
		$("#messenger_button").on('click',function(){
			...
			var indexWindow = window.open("/ORAI/MessengerView/AuxPage.jsp", "_blank", opt);
		});	
